...
export class IncidenteComponent implements OnInit, OnDestroy {
  ...
  constructor(protected incidenteService: IncidenteService, protected eventManager: JhiEventManager, protected modalService: NgbModal) {}

  loadAll(): void {
    this.incidenteService.query().subscribe((res: HttpResponse<IIncidente[]>) => {
      this.incidentes = res.body ? res.body : [];
    });
  }
